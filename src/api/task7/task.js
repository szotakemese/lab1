task7 ={
    ...
    if(n>=100){
        ...
        response.send("n= "+n+"<p>Number is too big. </p><h4>Enter a new number: http://localhost:3000/api/task7?n= ...</h4>")
    }
    response.send("n= "+n+"<p>Number is too small</p><h4>Enter a new number: http://localhost:3000/api/task7?n= ...</h4>")
}
}
